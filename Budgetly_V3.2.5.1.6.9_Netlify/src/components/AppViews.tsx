...
export function DebtPayoffView({ userId }: { userId: string | null }) {
  ...
  const [debtForm, setDebtForm] = useState({ name: '', lender: '', type: 'Credit Card', status: 'active', current_balance: '0', interest_rate: '0', minimum_payment: '0', due_day_or_date: '', original_balance: '0', target_payoff_date: '', payment_frequency: 'monthly', note: '', icon: '💳', mark_focus_debt: false, include_in_calculation: true })
